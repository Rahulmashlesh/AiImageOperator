...
import (
	...
	"AiImageOperator/internal/controller"
...
func init() {
	...
	utilruntime.Must(aiexamplecomv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e12790f4.example.com",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&aiexamplecomv1.Image{}).SetupWebhookWithManager(mgr); err != nil {
